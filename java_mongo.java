...
public class java_mongo implements ActionListener {
    ...
    public java_mongo() {
        try {
            ...
            String connectionString = "mongodb+srv://" + encodedUsername + ":" + encodedPassword + "@cluster0.xcwdphv.mongodb.net/";
...
class Quiz_JFrame implements ActionListener{
    ...
    Quiz_JFrame(String name) {
        ...
        String[][] options = {
                ...
                {"int[][] arr = new int[3,3];", "int arr[][] = new int[3][3];", "int arr[][] = new int[3,3]", "int[][] arr = new int(3)(3);"},
                {"It executes if an exception is thrown.", "It always executes, regardless of whether an exception is thrown or not.", "It handles the exception.", "It indicates where the exception occurred."},
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        String[] correctAnswers = 
                {"sizeof", "int arr[][] = new int[3][3];", "It always executes, regardless of whether an exception is thrown or not.", "final", "JButton"
                 };
